...
GOAT_ENGINE::Light::Light(glm::vec3 _position): position(_position), color(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f)), model(glm::mat4(1.0f)), shader("light.vert", "light.frag") {
}

GOAT_ENGINE::Light::Light(glm::vec3 _position, glm::vec4 _color): position(_position), color(_color), model(glm::mat4(1.0f)), shader("light.vert", "light.frag") {
}

void GOAT_ENGINE::Light::Activate(Shader objShader) {
	shader.Activate();
